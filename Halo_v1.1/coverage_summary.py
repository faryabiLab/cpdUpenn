#un this script as : python MakingOfCoverageSummary.py <SampleName> <Description>
...
import sys
infileName=sys.argv[1]+".sample_interval_summary" ## Opens up Sample's Depth.sample_interval_summary file.
outfileName=sys.argv[1]+".MeanCovByPosition"  ## Specifying the output file.
