...
perl /home/bdaber01/vcftools_0.1.9/perl/vcf-sort -c $1/$1.GenotypeGivenAlleles.vcf > $1/$1.GenotypeGivenAlleles.sorted.vcf
perl /home/bdaber01/vcftools_0.1.9/perl/vcf-sort -c $1/$1.DepthForAnnotation.vcf >  $1/$1.DepthForAnnotation.sorted.vcf
