    ...
    with open(anno, 'r') as anno_in:
        with open(anno_out, 'w+') as parsed:
            ...
            for line in anno_in:
                ...
                onc_type = values[9]
                sample_name = seq_id # CHANGE THIS!!!
                rs_id = 'rs' + values[387] # Updated
                rs_val = values[399] # Updated
                ...
                hgvs_c_change = values[253]
                hgvs_p_change = values[255]
                hgvs_g_change = values[254] # Updated

                sift_pred = values[324]
                clinvar_id = values[125]
                hgnc_omimid = values[240]
                ...
                snpeff_split = snpeff_ann.split(',')
                #temp_snpeff_effect= values[127] # snpeff_split[1] returning wrong effect occasionally
                #if temp_snpeff_effect == "missense":
                #    snpeff_effect = "missense_variant"
                #else:
                #    snpeff_effect = temp_snpeff_effect
                ...
                depth = values[404] # depth_across_samples
