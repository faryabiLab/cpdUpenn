...
#
#
#  Created by Ashkan Bigdeli 10/2/16
#  Updated by Ashkan Bigdeli 12/3/18


##################################  Set Run Directory and Parameters #################################
...
#################################### Write Calls to Isilon ####################################

if [[ $(wc -l <${variants_upload}) -ge 2 ]] ; then
...
rsync *PDF cpdlab@170.212.141.107:/PathCPD/FromHPC/HiSeqRun/Project_${project}/Sample_${SampleName}/
