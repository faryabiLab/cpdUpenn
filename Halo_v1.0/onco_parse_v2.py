...
# onco parse
def onco_parse(anno,anno_out, depth_ref, alt_depth_ref, vaf_ref):
    with open(anno, 'r') as anno_in:
        with open(anno_out, 'w+') as parsed:
            ...
            for line in anno_in:
                ...
                cosmic_tissue_type = values[58]
                cosmic_total_alteration = values[59]
                ...
                if int(depth) < depth_ref:
                    continue
                if alt_depth < alt_depth_ref:
                    continue
                if float(vaf) < vaf_ref:
                    continue
                parsed.write(sample_name + '\t' + chrom + '\t' + start_pos + '\t' + ref + '\t' + alt + '\t' + onc_type + '\t' + 'NA' + '\t' + qual + '\t' +
                             str(depth) + '\t' + 'NA' + '\t' + geneid + '\t' + gene + '\t' + 'NA' + '\t' + snpeff_transcript + '\t' + 'NA' + '\t' + transcript_loc +
                             ...
                             + gene + '\t' + geneid + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' +
                             '\t' + 'NA' + '\t' + start_pos + '\t' + end_pos + '\t' + hgvs_g_change + '\t' + c_dna_start + '\t' + c_dna_stop + '\t' + hgvs_c_change +
                             '\t' + hgvs_p_change + '\t' + 'NA' + '\t' + transcript_loc + '\t' + intron + '\t' + hgnc_omimid + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' +
                             ...
                             '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' +
                             '\t' + 'NA' + '\t' + 'NA' + '\t' +  'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' +
                             '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + cosmic_tissue_type + '\t' + 'NA' + '\t' + cosmic_total_alteration + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' +
                             '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' +
                             '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' + '\t' + 'NA' +
...
def parse_arguments():
    parser = argparse.ArgumentParser(description='parse the Oncotator annotated files.')
    parser.add_argument("-i", action="store", type=str, dest="oncotatorFile", help="Oncotator annotation file")
    parser.add_argument("-o", action="store", type=str, dest="outFile", help="fileMaker pro addapted file")
    parser.add_argument("-d", action="store", type=int, dest="total_depth_ref", default = 50, help="Min required depth")
    parser.add_argument("-a", action="store", type=int, dest="alt_depth_ref", default = 5, help="Min alternative depth")
    parser.add_argument("-f", action="store", type=float, dest="vaf_ref", default = 2.0, help="Min variant allelic frequency")
    
    args = parser.parse_args()
    return args

def main(args):  
    onco_parse(args.oncotatorFile, args.outFile, args.total_depth_ref, args.alt_depth_ref, args.vaf_ref)
