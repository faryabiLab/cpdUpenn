...
if(os.path.exists(FileName) and os.path.exists(FileName2) and os.path.exists(FileName3) and os.path.exists(FileName4) and os.path.exists(AmpliconFile) and os.path.exists(ClipStatFile) and os.path.exists(BtrimStatsR1) and os.path.exists(BtrimStatsR2)):
