...
##Changes in V1.2.4 : The 'elif [ $grepOut -eq 1 ]' statement was changed to 'elif [ $grepOut -ge 1 ]' to handle the instances where Fastq Generation is performed more than once for a run-folder.
