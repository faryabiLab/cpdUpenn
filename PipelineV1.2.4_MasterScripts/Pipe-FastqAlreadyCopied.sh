##V1.2.4
#!/bin/sh
##Run this script as ./Pipe-FastqAlreadyCopied.sh <RunFolderName> <PipelineVersion>
## Changes in V1.2.4 : a) Hashed many unecessary echo statements b) A sed statement to replace '-V2' to '_V2' is added as one of the step while modifying the SampleSheet.csv so as to handle the 'HEME_V2.0' string in the Description column of the SampleSheet correctly. 
