...
if(os.path.exists(FileName) and os.path.exists(FileName2) and os.path.exists(FileName3) and os.path.exists(FileName4) and os.path.exists(R1_fastq) and os.path.exists(R2_fastq) and os.path.exists(AmpliconFile)):
