...
##Changes in V1.4 : 1) Added the step to copy "SampleSheet_forMergeAnalysis_$Comp2.txt" to "SampleSheet_forMergeAnalysis.txt" so that the pipe further detects this sheet.
