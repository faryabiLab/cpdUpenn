##V1.2
## Run this script as python RecordsProcessing.py <pileupAndDepthJoined file> <GenotypeGivenAlleles file to be created> <AmpliconsWithDepthBelow250X file to be created> <DepthForAnnotation file to be created>
...
for eachline in Lines:       ## Runs the for loop on List of input lines.
	...
	if(int(TotalDepthAtPosition)<250):   ## The chromosome positions having total read depth below 250 are extracted.
		OutFile2.write(ChromPos[0]+"\t"+ChromPos[1]+"\t"+"."+"\t"+"."+"\t"+"."+"\t"+"."+"\t"+"."+"\t"+"."+"\t"+"."+"\t"+"."+"\n")
	...
	if(int(TotalDepthAtPosition)>0): ## Checks if there are some reads aligned at a particular position (TotalDepth>0). If yes,then it calculates the Percentage of Depth for ref base and all other possible alternate alleles.Finally prints such positions alongwith their ref and possible alternate alleles info in the DepthForAnnotation File.
		...
		OutFile3.write(ChromPos[0]+"\t"+ChromPos[1]+"\t"+"."+"\t"+RefBase+"\t"+AltBase1+"\t"+"."+"\t"+"."+"\t"+"FDP="+TotalDepthAtPosition+";FRD="+RefBaseDepth+";FAD="+AltBase1Depth+";FAF="+"{0:.2f}".format(AltBase1DepthPercent)+"\t"+"."+"\t"+"."+"\n")
		OutFile3.write(ChromPos[0]+"\t"+ChromPos[1]+"\t"+"."+"\t"+RefBase+"\t"+AltBase2+"\t"+"."+"\t"+"."+"\t"+"FDP="+TotalDepthAtPosition+";FRD="+RefBaseDepth+";FAD="+AltBase2Depth+";FAF="+"{0:.2f}".format(AltBase2DepthPercent)+"\t"+"."+"\t"+"."+"\n")
		OutFile3.write(ChromPos[0]+"\t"+ChromPos[1]+"\t"+"."+"\t"+RefBase+"\t"+AltBase3+"\t"+"."+"\t"+"."+"\t"+"FDP="+TotalDepthAtPosition+";FRD="+RefBaseDepth+";FAD="+AltBase3Depth+";FAF="+"{0:.2f}".format(AltBase3DepthPercent)+"\t"+"."+"\t"+"."+"\n")
