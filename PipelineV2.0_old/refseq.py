...
##Change in V1.2.4 : IndexError while parsing the exonicNC_list is now handled. This error occured previously for 'block substitutions' that didnt have any protein change reported in the exonic_variant_function file.
