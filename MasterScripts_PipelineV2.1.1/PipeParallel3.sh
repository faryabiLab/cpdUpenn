...
then
	...
	echo "Now Copying the Data from Run Folder on MiSeqOutputFolder to the Run Folder on Local Drive D.."
	cp $MiSeqOutputFolder/Data/Intensities/BaseCalls/*.fastq.gz $localFolder
