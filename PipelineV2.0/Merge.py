...
for eachSamplePair in SamplePairs:
	...
	PipelineScript_FILE.write("java -Xmx2G -jar /home/bdaber01/GenomeAnalysisTK-1.6-13-g91f02df/GenomeAnalysisTK.jar -R /home/bdaber01/Drive_D/Databases/genomes/hg19_genome.fa -T VariantFiltration --variant "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.vcf -o "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.vcf -dt NONE --filterName 'HomopolymerRun' --filterExpression 'HRun>6'" + "\n")
	#PipelineScript_FILE.write("echo 'grepping all variants not called at Homoploymer sites for further annotation..\n\n'"+"\n")
	#PipelineScript_FILE.write("grep -v 'HomopolymerRun' "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.filtered.vcf > "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.vcf"+"\n")
	
	# Annotating the variants
	
	PipelineScript_FILE.write("echo 'Running SnpEff Annotation--with canon option activated..\n\n'"+"\n")
	PipelineScript_FILE.write("/home/bdaber01/jdk1.7.0_80/bin/java -jar /home/bdaber01/snpEff_v_4.1/snpEff.jar -c /home/bdaber01/snpEff_v_4.1/snpEff.config -canon hg19 -i vcf -o vcf -noStats "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.vcf > "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.canon_snpeff.vcf"+"\n")
	PipelineScript_FILE.write("/home/bdaber01/jdk1.7.0_80/bin/java -jar /home/bdaber01/snpEff_v_4.1/SnpSift.jar varType "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.canon_snpeff.vcf > "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.canon_snpeff.vT.vcf"+"\n")
	PipelineScript_FILE.write("/home/bdaber01/jdk1.7.0_80/bin/java -jar /home/bdaber01/snpEff_v_4.1/SnpSift.jar extractFields "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.canon_snpeff.vT.vcf CHROM POS ID REF ALT QUAL FILTER DP ANN HET HOM VARTYPE >"+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.canon_snpeff.vT.ex.txt"+"\n")
	PipelineScript_FILE.write("python PrepareSnpEffOut.py "+SampleName+"/"+SampleName+".combined.HRunTagged.canon_snpeff.vT.ex.txt "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.canon_snpeff.vT.ex.tab"+"\n")
	...
	PipelineScript_FILE.write("python MultiAllelic.py "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.vcf "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.multiallelic.vcf"+"\n")
	PipelineScript_FILE.write("echo 'Running Annovar Refseq Annotation..\n\n'"+"\n")
	PipelineScript_FILE.write("perl /home/bdaber01/annovar_17thJun2015/convert2annovar.pl  -format vcf4old -includeinfo "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.multiallelic.vcf > "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.multiallelic.avinput"+"\n")
	PipelineScript_FILE.write("perl /home/bdaber01/annovar_17thJun2015/annotate_variation.pl "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.multiallelic.avinput /home/bdaber01/annovar_17thJun2015/humandb/ -buildver hg19"+"\n")
	PipelineScript_FILE.write("python refseq.py "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.multiallelic.avinput.variant_function "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.multiallelic.avinput.exonic_variant_function "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.multiallelic.avinput.refseq"+"\n")
	PipelineScript_FILE.write("echo 'Joining All Annotations..\n\n'"+"\n")
	PipelineScript_FILE.write("python AnnotationJoin.py "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.canon_snpeff.vT.ex.tab "+MergeDirectoryName+"/"+MergeDirectoryName+".combined.HRunTagged.multiallelic.avinput.refseq /Drive_D/Databases/1000Genomes/hg19.1000genomes.extractFields2.annovar_input "+MergeDirectoryName+"/"+MergeDirectoryName+".DepthForAnnotation.sorted.vcf /Drive_D/Databases/Alalmut/hg19.alamut_v1.4.2."+DescriptionP1+"_"+DescriptionP2+" "+MergeDirectoryName+"/"+MergeDirectoryName+".canon_annotated"+"\n")
