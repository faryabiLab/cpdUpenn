    ...
    with open(anno, 'r') as anno_in:
		...
		if transcript_strand == "+":
		    ...
		    strand="-1"
                ...
                sample_name = values[16] # Matched_Norm_Sample_Barcode
                rs_id = values[484] # dbsnp_147_RS << Yes, this is correct! Trust the numbers.
                rs_val = values[496] # dbsnp_147_VLD
                ...
                hgvs_c_change = values[279] # HGVS_coding_DNA_change
                hgvs_p_change = values[281] # HGVS_protein_change
                hgvs_g_change = values[280] # HGVS_genome_change

                sift_pred = values[420] # dbNSFP_SIFT_pred
                clinvar_id = values[140] # ClinVar_rs
                hgnc_omimid = values[266] # HGNC_OMIM ID(supplied by NCBI)
                ...
                depth = values[532] # read_depth
                #perform checks to determine which vcf generated the annotation. Unnecessary for lymphoma!
