...
##Changes in V2.0 : 1) $1/$1.Depth.below150X.vcf is added to the command line of RecordsProcessing.py.
...
python RecordsProcessing.py $1/$1.pileupAndDepth.joined $1/$1.GenotypeGivenAlleles.vcf $1/$1.Depth.below250X.vcf $1/$1.Depth.below150X.vcf $1/$1.DepthForAnnotation.vcf
