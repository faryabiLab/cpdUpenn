...
for eachSamplePair in SamplePairs:
	...
	PipelineScript_FILE.write("/home/bdaber01/jdk1.7.0_80/bin/java -Xmx6G -Djava.io.tmpdir=tmp -jar /home/bdaber01/GenomeAnalysisTK-3.4-46/GenomeAnalysisTK.jar -R /home/bdaber01/Drive_D/Databases/genomes/hg19_genome.fa -K CPD_upenn_gatk.key -et NO_ET -T UnifiedGenotyper -I "+MergeDirectoryName+"/"+MergeDirectoryName+".novo.primer.sorted.fixed.ontarget.MERGED.fixed.bam --dbsnp /home/bdaber01/Drive_D/Databases/dbsnp/hg19_dbsnp137_correct.vcf -o "+MergeDirectoryName+"/"+MergeDirectoryName+".GATK.primer.pre_filtered.vcf -nct 1 -glm INDEL -mbq 22 -dt NONE -minIndelCnt "+minIndelCount+" -minIndelFrac "+minIndelFrac+" -nda -maxAltAlleles 5 -stand_emit_conf 10.0 -L "+BED_FILE_for_P1_PrimersOn+" -L "+BED_FILE_for_P2_PrimersOn+"\n")
	PipelineScript_FILE.write("echo 'waiting for 1 minute before executing next command'"+"\n")
	PipelineScript_FILE.write("sleep 1m"+"\n")
	...
	PipelineScript_FILE.write("/home/bdaber01/jdk1.7.0_80/bin/java -Xmx6G -Djava.io.tmpdir=tmp -jar /home/bdaber01/GenomeAnalysisTK-3.4-46/GenomeAnalysisTK.jar -R /home/bdaber01/Drive_D/Databases/genomes/hg19_genome.fa -K CPD_upenn_gatk.key -et NO_ET -T UnifiedGenotyper -I "+MergeDirectoryName+"/"+MergeDirectoryName+".novo.sorted.fixed.ontarget.afterFilter.clipped.MERGED.fixed.bam --dbsnp /home/bdaber01/Drive_D/Databases/dbsnp/hg19_dbsnp137_correct.vcf -o "+MergeDirectoryName+"/"+MergeDirectoryName+".GATK.af4percent.vcf -nct 1 -glm SNP -mbq 22 -dt NONE -alleles:VCF "+MergeDirectoryName+"/"+MergeDirectoryName+".GenotypeGivenAlleles.sorted.vcf -gt_mode GENOTYPE_GIVEN_ALLELES -out_mode EMIT_ALL_SITES -stand_emit_conf 10.0 -L "+BED_FILE_for_P1+" -L "+BED_FILE_for_P2+"\n")
	PipelineScript_FILE.write("echo 'waiting for 1 minute before executing next command'"+"\n")
	PipelineScript_FILE.write("sleep 1m"+"\n")
